    ...
    <section aria-labelledby="company-info" className="mt-[150px] pb-[60px]">
      <div className="mx-auto w-full">
        ...
        <motion.div
          ...
          className="relative mx-auto mb-6 w-full max-w-[1200px] overflow-hidden rounded-2xl border border-emerald-900/10 bg-white/85 shadow-[0_10px_30px_rgba(0,0,0,0.06)] ring-1 ring-emerald-900/5 backdrop-blur-sm"
        >
          ...
          <div className="relative grid min-h-[324px] grid-cols-1 gap-8 p-6 md:min-h-[340px] md:grid-cols-12 md:p-8">
            ...
            <div className="md:col-span-7">
              <div className="grid grid-cols-3 gap-3 md:gap-4">
                <div className="flex h-full flex-col justify-between rounded-xl border border-emerald-900/10 bg-white/80 p-4 shadow-sm transition-shadow hover:shadow-[0_10px_24px_rgba(0,0,0,0.08)]">
              ...
              <div className="mt-4 rounded-xl border border-emerald-900/10 bg-white/85 px-4 py-[26px] shadow-sm transition-shadow hover:shadow-[0_10px_24px_rgba(0,0,0,0.08)] md:px-5 md:py-[30px]">
                ...
                <div className="grid grid-cols-1 items-start gap-4 md:grid-cols-12">
                  ...
                  <div className="md:col-span-2 md:self-stretch">
                    <div className="flex h-full items-center justify-center m-0 p-0">
                      <Image src="/metsa-hind-ikoon.png" alt="Metsa Hind" width={72} height={72} className="block m-0 p-0 h-[72px] w-[72px] object-contain sm:h-[80px] sm:w-[80px]" />
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-10">
                    <div className="grid grid-rows-[auto_auto] gap-3">
                      ...
                      {/* Row 2: bullets */}
                      <ul className="flex gap-4 md:flex-nowrap mb-0 mt-[5px]">
